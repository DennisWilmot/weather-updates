...
export const distributionSchema = z.object({
  ...
  itemsDistributed: z.array(z.enum(DISTRIBUTION_ITEMS as unknown as [string, ...string[]]))
    .optional(),
  ...
  recipientDateOfBirth: z.date().max(new Date(), 'Date of birth cannot be in the future'),
  ...
  (data) => {
    ...
    return data.assetId !== undefined || (data.itemsDistributed !== undefined && data.itemsDistributed.length > 0);
  },
  {
  ...
  (data) => {
    ...
    return data.personId !== undefined || (data.recipientFirstName !== undefined && data.recipientLastName !== undefined);
  },
  {
