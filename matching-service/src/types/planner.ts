/**
 * Core types for the global allocation planner system
 * 
 * These types define the data structures used for:
 * - Input: Warehouses (supply), Communities (demand nodes), Needs (demand)
 * - Constraints: Planning parameters (reserve fractions, distance limits, weights)
 * - Output: Shipments (allocation plan) and summary statistics
 */
