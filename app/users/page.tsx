...
interface User {
    ...
    email: string;
    role: string;
    status: "active" | "suspended"; // local-only until you add to DB
...
export default function UsersPage() {
    ...
    const [newUser, setNewUser] = useState({
        ...
        email: "",
        role: "",
        status: "active", // local-only until you add to DB
        lastActiveAt: "",
        createdAt: "",
        imageUrl: "",
        organization: "",
        ...
        fetch('/api/users')
            ...
            .then(data => {
                ...
                const normalized = data.users.map((u: any) => ({
                    ...
                    // TEMP: status is NOT in DB; default to active
                    status: "active",
                                    ...
                                    <tbody className="bg-white divide-y divide-gray-100">
                                        {paginatedUsers.map(user => (
                                            ...
                                            >
                                                ...
                                                <td className="px-6 py-4 text-sm text-gray-600">{new Date(user.lastActiveAt as any).toLocaleString()}</td>
                                ...
                                >
                                    ...
                                    <div className="space-y-3">
                                        ...
                                        <div className="flex items-center justify-between pt-3 border-t border-gray-100">
                                            <span className="text-xs text-gray-500">Last login: {new Date(user.lastActiveAt as any).toLocaleString()
                                            }</span>
                                        </div>
                                    </div>
                                </div>
                                    ...
                                    <div className="p-6 space-y-6 overflow-y-auto max-h-[calc(90vh-220px)]">
                                        <div className="grid grid-cols-1 sm:grid-cols-2 gap-4">
                                            ...
                                            <div>
                                                ...
                                                <p className="text-gray-900 px-4 py-2 bg-gray-50 rounded-lg border border-gray-200">{new Date(selectedUser.lastActiveAt as any).toLocaleString()}</p>
                                            </div>
                                            <div>
                                    ...
                                    <div className="p-6 space-y-4">
                                        <div>
                                            ...
                                            <input
                                                ...
                                                onChange={(e) => setNewUser({ ...newUser, fullName: e.target.value, status: "active" })}
                                                className="w-full px-4 py-2 border border-gray-300 rounded-lg focus:outline-none focus:ring-2 focus:ring-blue-500"
